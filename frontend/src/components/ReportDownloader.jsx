...
const ReportDownloader = ({ analysis, fileName = "Не указано" }) => {
  ...
  const getGrade = () => {
    if (analysis?.grade) return analysis.grade.toUpperCase();
  ...
  return (
    <>
      ...
      <HiddenTemplate ref={reportRef}>
        ...
        <DocumentTitle>
          <Title>АКТ ПРОВЕРКИ И ОЦЕНКИ</Title>
          <Subtitle>выпускной квалификационной работы (ВКР)</Subtitle>
        ...
        <Section>
          <SectionTitle>СВОДНАЯ ВЕДОМОСТЬ ОЦЕНКИ КРИТЕРИЕВ ВКР</SectionTitle>
          <ResultsTable>
            <thead>
              <tr>
                <TableHeader>Критерий оценивания</TableHeader>
                <TableHeader style={{ textAlign: 'center' }}>Набрано</TableHeader>
                <TableHeader style={{ textAlign: 'center' }}>Максимум</TableHeader>
              </tr>
            </thead>
            <tbody>
              <tr>
                <TableCell>1. Оформление текста (шрифт, размер, интервал, нумерация)</TableCell>
                <TableCell style={{ textAlign: 'center', fontWeight: 700 }}>{analysis?.fontTotal ?? 0}</TableCell>
                <TableCell style={{ textAlign: 'center' }}>20</TableCell>
              </tr>
              <tr>
                <TableCell>2. Объём работы (общий, введение, заключение)</TableCell>
                <TableCell style={{ textAlign: 'center', fontWeight: 700 }}>{analysis?.volumeTotal ?? 0}</TableCell>
                <TableCell style={{ textAlign: 'center' }}>25</TableCell>
              </tr>
              <tr>
                <TableCell>3. Структура и содержание (главы, подразделы, разделы)</TableCell>
                <TableCell style={{ textAlign: 'center', fontWeight: 700 }}>{analysis?.structureTotal ?? 0}</TableCell>
                <TableCell style={{ textAlign: 'center' }}>55</TableCell>
              </tr>
              <tr style={{ background: '#F8FAFC', fontWeight: 700 }}>
                <TableCell><strong>ИТОГО</strong></TableCell>
                <TableCell style={{ textAlign: 'center', fontWeight: 800, fontSize: 14 }}><strong>{analysis?.totalScore ?? 0}</strong></TableCell>
                <TableCell style={{ textAlign: 'center', fontWeight: 800 }}><strong>100</strong></TableCell>
              </tr>
            </tbody>
          </ResultsTable>
        </Section>
        ...
        <SignaturesSection>
          <SignaturesTitle>СОСТАВ АТТЕСТАЦИОННОЙ КОМИССИИ</SignaturesTitle>
          <CommissionGrid>
